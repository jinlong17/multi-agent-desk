...
| Codex app-server account APIs | CLI `0.142.5`, `0.143.0`, `0.144.2` | macOS 26.5.2 arm64 | versioned schema generation; initialize; account, rate-limit, and usage reads; canonical JSON schema identification | `spikes/codex/app-server-account-matrix.json`, `spikes/codex/p3-schema-reconcile.json`, `spikes/codex/2026-07-14-auth-refresh-spike.md` | Supported for exact tested account methods; P3 Session remains pending | canonicalize JSON before fingerprinting; probe exact schema and disable unsupported capabilities; never fabricate official usage | 2026-07-15 |
...
acceptance remain pending P3 gates.
