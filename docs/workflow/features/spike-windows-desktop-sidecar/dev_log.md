...
| Updated | `2026-07-14 19:43 -0700` |
| Suggested Next | `Phase 0.5 consolidation; apply ADR 0015 in Phase 5/6 Windows Desktop implementation and acceptance` |
...
| Decision Record | `docs/adr/0015-windows-tauri-sidecar-lifecycle.md`; `docs/PROVIDER_COMPATIBILITY.md` |
...
| 2026-07-14 19:43 -0700 | Feature-plan decision after security-review `ACCEPTED` | ADR 0015 selects discover-first, fixed signed Rust externalBin launch, crash-surviving/reconnectable daemon, authenticated ownership/explicit stop, atomic updates, service fallback, and retained Windows 11 acceptance | `docs/adr/0015-windows-tauri-sidecar-lifecycle.md`; `docs/PROVIDER_COMPATIBILITY.md` |

## Result, limitations, and fallback

Gate resolved. The real Tauri externalBin/NSIS build launched the resolved
...
orphan count was zero. ADR 0015 freezes the discover-first, crash-surviving,
authenticated-ownership lifecycle. Fallback: Windows Desktop stays Experimental
and uses a separately installed signed Daemon service.

## Risks and Blockers

- No remaining Phase 0.5 Windows lifecycle decision blocker; ADR 0015 obligations become Phase 5/6 implementation and release-acceptance gates.
...
| 2026-07-14 19:43 -0700 | Codex (GPT-5), feature-plan | Recorded ADR 0015, synchronized Desktop lifecycle rules, compatibility matrix, threat model, ADR markers, Phase 0.5/5/6 gates, risk register, and operator dashboard binding | ADR 0015; plan; compatibility; threat model; dashboard; this file | `GATE_RESOLVED`; Windows Desktop remains Experimental pending signed Windows 11 acceptance | Phase 0.5 consolidation / Phase 5 and 6 |
