...
| [0016](0016-claude-profile-interactive-login-boundary.md) | Claude target-profile interactive login boundary | Accepted |
...
ADR 0010 through ADR 0016 are Phase 0.5 evidence-backed decisions. ADR 0010
...
implementation is complete. ADR 0016 selects target-local official Claude login
and leaves setup-token CredentialGrant, distinct-account isolation, and
long-session behavior unsupported by the Spike.
